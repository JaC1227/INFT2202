...
let newUser = new userClass.User("Jaedyn", "Chinn", "jaedyn.chinn", "hello@example.ca", "fakePassword");
...
// import * as formValidation from form.js;
// We did thia at the top of the file as to follow most industry standards
...
if ($('.gallery'))
{
    ...
    $(function()
    {
        ...
        setInterval(function()
        {
            ...
            galleryImageImage.fadeOut(1000, function()
            {
